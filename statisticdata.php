...
<?php
$typera = 'High Rain';
 $sql1 = "Select * from predictionstatistics where predictcategory='$typera';";
 
 $typerb = 'Low Rain';
 $sql2 = "Select * from predictionstatistics where predictcategory='$typerb';";
 
 $typerc = '80 High Rain';
 $sql3 = "Select * from predictionstatistics where predictcategory='$typerc';";
 
 $typerd = '80 Low Rain';
 $sql4 = "Select * from predictionstatistics where predictcategory='$typerd';";
 
 $typere = '98 High Rain';
 $sql5 = "Select * from predictionstatistics where predictcategory='$typere';";
 
 $typerf = '98 Low Rain';
 $sql6 = "Select * from predictionstatistics where predictcategory='$typerf';";
