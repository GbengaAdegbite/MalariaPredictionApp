...
if($stmt = $dblink->query("SELECT timeindays,T,S,E,I,R,D,V FROM compartment_data where categories='80 High Rain' AND status='live';")){
...
<br/><br/>
<strong><em>Malaria Prediction Statistics for 80% High Rain</em></strong><br/><hr/><br/>
<?php
$typera = '80 High Rain';
 $sql1 = "Select * from prediction_dynamictable where predictcategory='$typera';";
$d1 = $dblink -> query($sql1);

  echo "<br/><br/><a name='sub'></a><center><caption><strong><em>Malaria Prediction for 80% High Rain</em></strong></caption></center><br/><table border='1' align='center' cellspacing='2' cellpadding='2' width='95%' bgcolor='#000066' style='color:#ffffff; font-weight:bold; font-family:Arial,Trebuchet; font-size:18px; border-collapse:collapse;'>
