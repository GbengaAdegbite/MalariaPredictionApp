...
<body>
<div style="width:90%; height:430px;">
<strong><em>Period of High Rain</em><span style="float:right;"><a href="#sub" style="text-decoration:none;background-color:#006; border-style:none; border-color:#006; color:#ffffff; border-radius:15px 15px;width:140px; height:45px; text-align:center; vertical-align:middle; padding:5px 5px 5px 5px; box-shadow:4px 2px 3px rgba(0,0,0,0.3);">View Preliminary Statistics</a></span></strong><br/>

<center><br/><div style=" width:100%;" id="curve_chart">
</div> 
<div id="floateddiv">
...
if($stmt = $dblink->query("SELECT timeindays,T,S,E,I,R,D,V,categories FROM compartment_data where status='live' and categories='High Rain';")){
...
?>
<br/><br/>
<strong><em>Malaria Prediction Statistics for High Rain</em></strong><br/><hr/><br/>
<?php
$typera = 'High Rain';
 $sql1 = "Select * from prediction_dynamictable where predictcategory='$typera';";
$d1 = $dblink -> query($sql1);

  echo "<br/><br/><a name='sub'></a><center><caption><strong><em>Malaria Prediction for High Rain</em></strong></caption></center><br/><table border='1' align='center' cellspacing='2' cellpadding='2' width='95%' bgcolor='#000066' style='color:#ffffff; font-weight:bold; font-family:Arial,Trebuchet; font-size:18px; border-collapse:collapse;'>
